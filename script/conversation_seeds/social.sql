...
('social_town_lunch_map', 1, 'town-square', 'user03', 2, 700, '@user18 この前話していたお弁当屋、今日も出ていますか？'),
...
('social_town_lost_umbrella', 6, 'town-square', 'user12', 5, 1039, '今度から明るい色のバンドも付けておきます。'),
...
('social_town_music_poll', 6, 'town-square', 'user35', 8, 787, '今くらいならちょうどよいです。選曲ありがとうございます。'),
...
('social_town_snack_share', 5, 'town-square', 'user24', 11, 931, 'せんべいおいしかったです。お茶にも合いました。'),
...
('social_town_window_weather', 6, 'town-square', 'user05', 15, 1027, '共有の傘が二本あるので、必要な方は声をかけてください。'),
...
('social_break_coffee_grind', 6, 'break-room', 'user04', 3, 889, 'もちろんです。小さいカップで用意します。'),
...
('social_break_fridge_label', 6, 'break-room', 'user20', 6, 760, '助かります。これで次からすぐ記名できますね。'),

('social_break_stretch', 1, 'break-room', 'user25', 9, 900, '@user07 肩まわりの短いストレッチ、前に教えていたものをもう一度やりませんか？'),
...
('social_break_tea_choice', 5, 'break-room', 'user17', 13, 641, 'ほうじ茶、香ばしくて飲みやすいです。'),
...
('social_break_fan_setting', 6, 'break-room', 'user21', 17, 800, '了解です。最後に出る人が窓を閉めましょう。'),

-- late-night-talk: 夜更けの作業を無理なく切り上げる会話。
('social_late_release_pause', 1, 'late-night-talk', 'user02', 4, 1320, '@user15 変更点の確認は終わりましたか？'),
...
('social_late_rain_sound', 4, 'late-night-talk', 'user08', 7, 1382, 'いま保存しました。明日のTODOも二つ残しました。'),
...
('social_late_bookmark', 6, 'late-night-talk', 'user29', 12, 1315, 'お疲れさまでした。続きが分かる状態なら安心ですね。'),
...
('social_late_keyboard', 5, 'late-night-talk', 'user01', 18, 1361, '眠気が来る前に、保存して休憩も入れてくださいね。'),
...
('social_remote_mic_test', 6, 'remote-lounge', 'user06', 1, 555, '設定しました。二人とも確認ありがとうございます。'),
...
('social_remote_delivery', 6, 'remote-lounge', 'user03', 6, 845, 'こちらは落ち着いているので、慌てなくて大丈夫です。'),
...
('social_remote_sunlight', 6, 'remote-lounge', 'user28', 10, 620, 'よかったです。午後に暗ければ元へ戻せますね。'),

('social_remote_focus_block', 1, 'remote-lounge', 'user32', 16, 845, '一時間だけ集中したいので、返事が少し遅れます。'),
...
('social_event_boardgame', 1, 'office-events', 'user07', 2, 950, '@user21 金曜の夕方、短いボードゲーム会を開きませんか？'),
...
('social_event_photo_walk', 1, 'office-events', 'user11', 5, 735, '昼休みに建物の周りを撮る小さな写真散歩を考えています。'),
...
('social_event_lightning_talk', 6, 'office-events', 'user25', 9, 1010, 'できます。残り一分で合図を出すようにします。'),
...
('social_event_cleanup', 4, 'office-events', 'user29', 13, 992, '助かります。終了後に十分だけお願いします。'),
...
('social_event_breakfast', 6, 'office-events', 'user06', 18, 530, '原材料も一緒に一覧へ書いておきます。'),

-- onboarding: 新しく参加した人の小さな疑問を周囲が解決する会話。
('social_onboard_channel_map', 1, 'onboarding', 'user39', 1, 585, '@user02 チャンネルが多いのですが、最初はどこを見ればよいですか？'),
...
('social_onboard_profile', 6, 'onboarding', 'user12', 4, 670, '親しみやすくなりました。これで十分だと思います。'),
...
('social_onboard_first_meeting', 6, 'onboarding', 'user31', 8, 575, 'ありがとうございます。短いメモだけ用意して参加します。'),
...
('social_onboard_terms', 6, 'onboarding', 'user09', 12, 825, '回答後に一覧へ追加しておくと、次の人にも役立ちますね。'),
...
('social_onboard_lunch_invite', 6, 'onboarding', 'user16', 17, 695, 'もし予定が変わっても気にせず、ここへ一言ください。'),

-- weekend-club: 休日の任意参加活動を穏やかに相談する会話。
('social_weekend_walk', 1, 'weekend-club', 'user08', 3, 620, '@user30 土曜の朝、川沿いを短く歩きませんか？'),
...
('social_weekend_cooking', 6, 'weekend-club', 'user33', 7, 710, '材料がそろっているので、今度作ってみます。'),
...
('social_weekend_puzzle', 6, 'weekend-club', 'user18', 11, 860, '了解です。見えないよう封筒に入れておきます。'),
...
('social_weekend_plants', 6, 'weekend-club', 'user25', 16, 630, 'では土と小石をまとめて袋へ入れておきます。'),
...
('social_one_pen', 6, 'one-liner', 'user22', 2, 650, '滑らかでよいですね。次に買う候補にします。'),
...
('social_one_cloud', 6, 'one-liner', 'user27', 6, 950, '数分で別のものに見えるのが面白いですね。'),

('social_one_timer', 1, 'one-liner', 'user17', 10, 905, '二十五分のタイマーを使うと、着手だけはしやすくなりました。'),
...
('social_one_socks', 6, 'one-liner', 'user06', 15, 610, 'その判断、朝から少し元気が出ました。'),

-- mystery-lab: 身近な違和感を安全に観察して解く軽い謎。
('social_mystery_clock', 1, 'mystery-lab', 'user03', 4, 745, '休憩室の時計だけ、ほかより三分進んで見えます。'),
...
('social_mystery_footprints', 6, 'mystery-lab', 'user26', 8, 700, 'きれいに拭いて、鉢の下へ受け皿を置きました。'),
...
('social_mystery_note', 6, 'mystery-lab', 'user14', 13, 730, '持ち主が見つかりました。注文番号の控えだったそうです。'),
...
('social_mystery_hum', 6, 'mystery-lab', 'user30', 19, 850, '原因が分かって安心しました。担当へ交換を依頼します。');
